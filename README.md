...
```
This directory contains code and data for "Top-K Interesting Subgraph Discovery in Information Networks".
...
===========================================================================================================
Any questions?
Please drop me (Manish Gupta) an email at gmanish@microsoft.com
```
